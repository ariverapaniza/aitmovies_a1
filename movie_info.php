    ...
    <div id="reviewCarousel" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
            ...
            while ($reviewRow = $reviewResult->fetch_assoc()) {
                ...
                echo '<h5 class="card-title"><strong>Username: </strong>' . htmlspecialchars($reviewRow['rusername']) . '</h5>';
                echo '<h5 class="card-text"><strong>Review: </strong>' . htmlspecialchars($reviewRow['review']) . '</h5>';
                echo '<h5 class="card-text"><strong>Rating: </strong>' . htmlspecialchars($reviewRow['rating']) . '/5 <i class="bi bi-star-fill text-warning"></i></h5>';
                echo '</div>';
                echo '</div>';
                echo '</div>';
                $index++;
